...
This is a base template for **Angular 2.0.0-rc.6** . It contains the core files you will need when starting an Angular 2 project.
...
https://github.com/MostafaAttia/angular2-starter.git
